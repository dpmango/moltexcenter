...
class Separator extends Component {
  render() {
	...
	<div className="parallax__group h320">
	  	<Hero img={heroImg} title="Сепараторы ОДМЕЗ" subheading="Новые с заводской гарантией" desc="Производительностью от 500 до 10 000 л/час <br /> От эксклюзивного диллера на территории РФ"/>
